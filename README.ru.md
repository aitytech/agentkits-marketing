...
<p align="center">
  <a href="README.md">English</a> | <a href="README.vi.md">Tiếng Việt</a> | <a href="README.ja.md">日本語</a> | <strong>Русский</strong>
</p>
...
|
|-- training/            # 23 интерактивных урока (английский)
|-- training-vi/         # Обучение на вьетнамском (Tiếng Việt)
|-- training-ja/         # Обучение на японском (日本語)
...
### Вариант 1: Установка через npx (Рекомендуется)
...
### Вариант 2: Клонирование и использование
...
### Вариант 3: Установка как плагин (Скоро)

> **Примечание:** Отправка в маркетплейс плагинов ожидает одобрения.

После одобрения установите напрямую через систему плагинов Claude Code:

```bash
# Добавить этот репозиторий как маркетплейс
...
/training:start-0-0           # Английский
/training-vi:start-0-0        # Вьетнамский (Tiếng Việt)
/training-ja:start-0-0        # Японский (日本語)
```

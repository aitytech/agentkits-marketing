...
**重要**：使用与用户相同的语言进行回复。如果是越南语，则用越南语回复。如果是西班牙语，则用西班牙语回复。

---

## Claude的指令

最后一课 - 使用SEO命令教授全面的SEO策略和执行。
...
SEO推动可持续的长期增长。让我们掌握关键词研究、内容优化和技术SEO。
...
**恭喜！您已完成AgentKits营销精通课程！**

您现在知道如何：
- ✅ 使用18个专业营销代理
- ✅ 执行76个斜杠命令
- ✅ 遵循3个核心工作流程（营销、销售、CRM）
- ✅ 创建全面的活动简报
- ✅ 构建内容策略
- ✅ 大规模生成营销文案
- ✅ 分析数据并创建报告

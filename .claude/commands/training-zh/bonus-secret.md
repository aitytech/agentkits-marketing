...
**关键**：使用用户所用的相同语言进行回应。如果是越南语，则用越南语回应。如果是西班牙语，则用西班牙语回应。

---

## Claude 指令

这是一节秘密奖励课程,揭示了高级的"10倍营销人员框架" - 这个系统将优秀营销人员与卓越营销人员区分开来。
...
*恭喜您发现了这节秘密课程!这个框架将改变您使用营销工具包的方式。*

---

## 10倍营销人员思维模式

大多数营销人员采用**线性**工作方式 - 每个营销活动都需要相同的努力。

**10倍营销人员**采用**指数级**工作方式 - 每个营销活动都让下一个更快更好。
...
**审查阶段:**
- `brand-voice-guardian` → 品牌语调检查
- `conversion-optimizer` → 转化率优化审查
- `seo-specialist` → SEO验证
- 角色审查者 → 受众匹配度

**优化阶段:**
- `lead-qualifier` → 潜在客户质量
- `email-wizard` → 序列优化
- `continuity-specialist` → 留存
...
1. **精通命令链** - 练习工作流
2. **策略性使用代理** - 为正确的任务选择正确的代理
3. **记录一切** - 构建您的模式库
4. **定期审查** - 每日、每周、每月的例行工作
5. **跟踪您的速度** - 测量每个营销活动的时间
...
**10倍框架不是关于更努力地工作。而是关于构建能够产生复利的系统。**

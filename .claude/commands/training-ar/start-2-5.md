# /training:start-2-5 - التحليل التنافسي
...
علّم استراتيجية البحث التنافسي الشاملة وتحديد المواقع.

### نظرة عامة على الدرس

---

**الوحدة 2.5: التحليل التنافسي**

فهم المشهد التنافسي الخاص بك أمر حاسم لتحديد المواقع والرسائل. لنبحث منافسي AgentKits بشكل منهجي.

**المدة:** ~30 دقيقة

---

### الخطوة 1: التحليل العميق للمنافسين
...
### الخطوة 3: تحليل المنافسة في تحسين محركات البحث

استخدم أمر منافس SEO:
...
راجع:
- الكلمات المفتاحية التي يحتلون مرتبة فيها
- استراتيجية المحتوى
- ملف الروابط الخلفية
- تحسين محركات البحث التقني

### الخطوة 4: إنشاء بطاقات المعركة

استخدم أمر بطاقة معركة المبيعات:
...
راجع محتوى بطاقة المعركة:
- مقارنة سريعة
- سيناريوهات الفوز
- معالجة الاعتراضات
- نقاط الإثبات

### الخطوة 5: مصفوفة تحديد المواقع

أنشئ تحديد المواقع التنافسي:
...
### الخطوة 7: مقارنة الميزات

أنشئ جدول مقارنة الميزات:
...
### الخطوة 8: دليل الاستجابة التنافسية

أنشئ سيناريوهات الاستجابة:
...
### الخطوة 9: تأهيل المبيعات

استخدم تأهيل المبيعات:
...
### الخطوة 10: ملخص التمايز

أنشئ ملخصاً من صفحة واحدة:
...
أخبرهم:
- لديهم معلومات تنافسية شاملة
- جاهزون لتحديد المواقع والرسائل بفعالية
- **الدرس النهائي:** `/training:start-2-6` - تحسين محركات البحث
- إتقان تحسين محركات البحث

## نقاط التدريس الرئيسية
- `/competitor:deep` يوفر تحليلاً كاملاً
- `/seo:competitor` يكشف استراتيجية SEO
- `/sales:battlecard` يمكّن فريق المبيعات
- مصفوفة تحديد المواقع تظهر التمايز
- أدلة الاستجابة تُعد للسيناريوهات
